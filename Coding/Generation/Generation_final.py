...
"""
        ...
        while True:
            follow = prompt_multiline(
                "Are you satisfied? Type 'yes' to finish, 'back' to restart, or enter new instructions:"
            )
            ...
            if follow.lower() in ("r", "regenerate"):
                follow_text = "Regenerate this section with improved clarity and specificity."
            else:
                follow_text = follow
